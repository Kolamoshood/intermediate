                    ...
                    <div class="container">
                        <div class="mobile-responsive-menu">
							...
							<div class="others-options-for-mobile-devices">
								<ul>
									<li>
										<a href="login.blade.php" class="default-btn">
											Student Portal
										</a>
									</li>
									<li>
										<a href="register.blade.php" class="default-btn">
											Register
										</a>
									</li>
								</ul>
					...
					<div class="col-lg-3 col-sm-6">
						<div class="single-footer-widget">
							...
							<ul class="import-link">
								<li>
									<a href="login.blade.php">Student Portal</a>
								</li>
								<li>
						...
						<div class="single-footer-widget">
							...
							<ul class="address">
								...
								<li>
									...
									<span>Email</span>
									<a href="https://templates.envytheme.com/cdn-cgi/l/email-protection#4c25222a230c39222f23622f2321"><span class="__cf_email__" data-cfemail="2a43444c456a5f44494504494547">[email&#160;protected]</span></a>
								</li>
								<li>
